...
![Log Configuration]({{site.url}}/assets/images/loggingConfigurationAnnotated.png){: width=3000 height=2000 .full}
### Security settings
...
![Security Configuration]({{site.url}}/assets/images/securitySettingsAnnotated.png){: width=3000 height=2000 .full}
